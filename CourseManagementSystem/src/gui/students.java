...
public class students {
    ...
    private void initialize() {
        ...
        textField.setBounds(31, 10, 243, 37);
        panel_2.add(textField);

        JButton addCoursebtn = new JButton("Edit Student");
        ...
        addCoursebtn.setBounds(284, 10, 138, 37);
        panel_2.add(addCoursebtn);

        JButton editCoursebtn = new JButton("Delete Student");
        editCoursebtn.setFont(new Font("Garamond", Font.PLAIN, 19));
        editCoursebtn.setBackground(SystemColor.textHighlightText);
        editCoursebtn.setBounds(432, 10, 147, 37);
        panel_2.add(editCoursebtn);

        JButton btnNewButton_3 = new JButton("View Progress");
